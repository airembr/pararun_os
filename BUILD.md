To build and publish your `pararun` package to PyPI, follow these steps:
...
- The `__init__.py` file inside `pararun/` ensures it's treated as a package.
...
```sh
pip install dist/airembr_pararun_os-0.0.1-py3-none-any.whl
```
